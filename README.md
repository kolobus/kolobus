...
#### Current builds
- 🔐 [haveibeenfiltered](https://haveibeenfiltered.com) — Offline breach checking for 2B passwords using Ribbon filters
...
- 🏥 [mri.pics](https://mri.pics) — Free DICOM viewer, 100% client-side
- 📝 [thinkstack.blog](https://thinkstack.blog) — Tech writing
